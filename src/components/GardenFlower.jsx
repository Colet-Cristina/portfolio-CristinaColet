...
function GardenFlower({ isCenter }) {
  return (
    <div
      className={`flower ${isCenter ? "flower--active" : ""}`}
      aria-hidden="true"
    >
      <span className="flower__stem"></span>
      <span className="flower__leaf flower__leaf--left"></span>
      <span className="flower__leaf flower__leaf--right"></span>

      <svg className="flower__svg" viewBox="0 0 400 230">
        <defs>
          <radialGradient
            r="0.5"
            cy="0.5"
        ...
        <g>
          ...
          <path
            id="center"
            className="flower__petal flower__petal--center"
          ...
          <path
            id="l1"
            className="flower__petal flower__petal--left"
          ...
          <path
            id="r1"
            className="flower__petal flower__petal--right"
